...
@section('title', __('dashboard.permissions_list'))
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
                                <h4 class="card-title mb-0">{{ __('dashboard.permissions_list') }}</h4>
                                <a href="{{ route('dashboard.permissions.create') }}" class="btn btn-primary btn-md">
                                    <i class="feather icon-plus mr-1"></i> {{ __('dashboard.add_permission') }}
                                </a>
                            </div>
                                        ...
                                        <table class="table table-hover mb-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>{{ __('dashboard.display_name') }}</th>
                                            ...
                                            <tbody>
                                                @forelse ($permissions as $permission)
                                                    <tr>
                                                        ...
                                                        <td>{{ \Illuminate\Support\Str::limit($permission->description, 60) ?: '-' }}</td>
                                                        <td class="table-actions-cell text-nowrap">
                                                            ...
                                                            <button type="button"
                                                                    ...
                                                                    onclick="remove({{ $permission->id }}, 'delete-permission')"
                                                                    title="{{ __('dashboard.delete') }}">
                                                                <i class="feather icon-trash"></i>
                                                            </button>
                                                            <form class="delete-permission-{{ $permission->id }} d-none"
