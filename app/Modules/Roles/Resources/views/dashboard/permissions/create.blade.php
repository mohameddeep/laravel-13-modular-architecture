...
@section('title', __('dashboard.add_permission'))
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            @include('base::components.dashboard.layouts._breadcrumb', ['items' => [
                ...
                ['label' => __('dashboard.add_permission')],
            ]])
                    ...
                    <div class="col-12 col-md-8 mt-2">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">{{ __('dashboard.add_permission') }}</h4>
                            </div>
                                    ...
                                    <form method="POST" action="{{ route('dashboard.permissions.store') }}">
                                        ...
                                        <div class="form-group mb-2">
                                            <label for="name">{{ __('dashboard.name') }}
                                                <small class="text-muted">({{ __('dashboard.permission_name_hint') }})</small>
                                            </label>
                                            <input type="text" id="name" name="name"
                                                   class="form-control @error('name') is-invalid @enderror"
                                                   value="{{ old('name') }}"
                                                   placeholder="e.g. users-create" required>
