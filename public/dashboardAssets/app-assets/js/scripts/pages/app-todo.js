  ...
  $(".add-todo-item").on('click', function(e){
    ...
    if(todoTitle != ""){
      $(".todo-task-list-wrapper").append('<li class="todo-item" style="animation-delay: 0s;"  data-toggle="modal" data-target="#editTaskModal">' +
        '<div class="todo-title-wrapper d-flex flex-wrap justify-content-between mb-50">' +
          '<div class="todo-title-area d-flex flex-wrap align-items-center">' +
            '<div class="title-wrapper d-flex flex-wrap">'+
          ...
          '</div>' +
          '<div class="float-right todo-item-action d-flex flex-wrap">' +
