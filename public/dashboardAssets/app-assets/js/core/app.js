...
(function (window, document, $) {
  ...
  i18next.use(window.i18nextXHRBackend).init({
      ...
      fallbackLng: "en",
      backend: {
        loadPath: "/dashboardAssets/app-assets/data/locales/{{lng}}.json"
      },
      returnObjects: true
    },
    function (err, t) {
  ...
  bookmarkStar.on("click", function (e) {
    ...
    for (var i = 0; i < arrList.length; i++) {
      ...
      $arrList +=
        '<li class="auto-suggestion d-flex flex-wrap align-items-center justify-content-between cursor-pointer ' +
        $activeItemClass +
        '">' +
        '<a class="d-flex flex-wrap align-items-center justify-content-between w-100" href=' +
    ...
    if (e.keyCode !== 38 && e.keyCode !== 40 && e.keyCode !== 13) {
      ...
      if (value != "") {
        ...
        var $startList = "",
          ...
          $htmlList = "",
          $bookmarkhtmlList = "",
          $pageList = '<li class=" d-flex flex-wrap align-items-center">' +
          '<a href="#" class="pb-25">' +
